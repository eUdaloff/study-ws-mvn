...
public class BuyTicketDialogRS extends JDialog implements WsResultListener {
    ...
    public BuyTicketDialogRS(JFrame parent, boolean modal) {
        super(parent, modal);
    ...
    private void btnBuyTicketActionPerformed() {
        ...
        showOrHideProgressBar(false);
        if (result) {
            MessageManager.showInformMessage(BuyTicketDialogRS.this, "Покупка билета", "Все хорошо. Куплен.");
            dispose();
        } else {
            MessageManager.showErrorMessage(BuyTicketDialogRS.this, "Покупка билета", "Ошибка. Не куплен.");
        }
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        txtFamilyName.setBackground(new Color(-26996));
        ...
        txtDocNum.setBackground(new Color(-26996));
        ...
        txtName.setBackground(new Color(-26996));
        ...
        txtCardNum.setBackground(new Color(-26996));
        ...
        comboBoxPlaces.setBackground(new Color(-26996));
