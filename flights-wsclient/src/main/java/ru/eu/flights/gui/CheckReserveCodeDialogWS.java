...
public class CheckReserveCodeDialogWS extends JDialog implements WsResultListener {
    ...
    public CheckReserveCodeDialogWS(Frame owner, boolean modal) {
        super(owner, modal);
    ...
    private void btnCheckReservationActionPerformed() {
        ...
        try {
            ...
            Logger.getLogger(CheckReserveCodeDialogWS.class.getName()).log(Level.SEVERE, null, e);
...
//                }
//                MessageManager.showInformMessage(CheckReserveCodeDialogWS.this, "Результат проверки", msg);
...
//        });
    ...
    public static void main(String[] args) {
        CheckReserveCodeDialogWS dialog = new CheckReserveCodeDialogWS(null, false);
        dialog.pack();
